...
<AppShell>
  <svelte:fragment slot="header">
    <AppBar gridColumns="grid-cols-3 md:grid-cols-11 content-center" slotLead="md:col-start-4 md:place-self-center" slotDefault="md:col-start-6 place-self-center" slotTrail="md:col-start-8 md:col-span-2 md:place-content-start">
